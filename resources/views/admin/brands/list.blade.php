            ...
            <form action="">
                ...
                <div class="card-header">
                    ...
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{url(route('brand.index'))}}'" class="btn btn-default btn-sm">
                            Reset
                        </button>
...
<script>
    function brandDelete(id) {
        var newUrl = "{{route('brand.destroy', 'ID')}}"
        var Url = newUrl.replace('ID', id);
