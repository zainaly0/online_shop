            ...
            <form action="" method="get">
                <div class="card-header">
                    ...
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{url(route('product.index'))}}'" class="btn btn-default btn-sm">
                            Reset
                        </button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('product.edit', $product->id)}}" class="text-danger w-4 h-4 mr-1">
